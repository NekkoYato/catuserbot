...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/NekkoYato/catuserbot) to open this bot source code\
        \nClick [here](https://github.com/NekkoYato/catpack) to open supported link for heroku",
    )
